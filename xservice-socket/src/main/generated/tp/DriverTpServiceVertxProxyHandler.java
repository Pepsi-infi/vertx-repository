...
public class DriverTpServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final DriverTpService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public DriverTpServiceVertxProxyHandler(Vertx vertx, DriverTpService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public DriverTpServiceVertxProxyHandler(Vertx vertx, DriverTpService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public DriverTpServiceVertxProxyHandler(Vertx vertx, DriverTpService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
