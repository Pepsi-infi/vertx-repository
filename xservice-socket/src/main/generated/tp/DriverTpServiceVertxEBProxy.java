...
public class DriverTpServiceVertxEBProxy implements DriverTpService {
  ...
  public DriverTpServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public DriverTpServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
