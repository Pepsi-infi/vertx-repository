...
@io.vertx.lang.rxjava.RxGen(tp.PassengerTpService.class)
public class PassengerTpService {

  public static final io.vertx.lang.rxjava.TypeArg<PassengerTpService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new PassengerTpService((tp.PassengerTpService) obj),
    PassengerTpService::getDelegate
  );

  private final tp.PassengerTpService delegate;
  
  public PassengerTpService(tp.PassengerTpService delegate) {
    this.delegate = delegate;
  }

  public tp.PassengerTpService getDelegate() {
    return delegate;
  }

  public static PassengerTpService createProxy(Vertx vertx) { 
    PassengerTpService ret = PassengerTpService.newInstance(tp.PassengerTpService.createProxy(vertx.getDelegate()));
    return ret;
  }
  ...
  public static  PassengerTpService newInstance(tp.PassengerTpService arg) {
    return arg != null ? new PassengerTpService(arg) : null;
  }
}
