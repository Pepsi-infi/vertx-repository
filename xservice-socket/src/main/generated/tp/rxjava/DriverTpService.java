...
@io.vertx.lang.rxjava.RxGen(tp.DriverTpService.class)
public class DriverTpService {

  public static final io.vertx.lang.rxjava.TypeArg<DriverTpService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new DriverTpService((tp.DriverTpService) obj),
    DriverTpService::getDelegate
  );

  private final tp.DriverTpService delegate;
  
  public DriverTpService(tp.DriverTpService delegate) {
    this.delegate = delegate;
  }

  public tp.DriverTpService getDelegate() {
    return delegate;
  }

  public static DriverTpService createProxy(Vertx vertx) { 
    DriverTpService ret = DriverTpService.newInstance(tp.DriverTpService.createProxy(vertx.getDelegate()));
    return ret;
  }
  ...
  public static  DriverTpService newInstance(tp.DriverTpService arg) {
    return arg != null ? new DriverTpService(arg) : null;
  }
}
