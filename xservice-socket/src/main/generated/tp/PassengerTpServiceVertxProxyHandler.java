...
public class PassengerTpServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final PassengerTpService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public PassengerTpServiceVertxProxyHandler(Vertx vertx, PassengerTpService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public PassengerTpServiceVertxProxyHandler(Vertx vertx, PassengerTpService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public PassengerTpServiceVertxProxyHandler(Vertx vertx, PassengerTpService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "auth": {
          service.auth((io.vertx.core.json.JsonObject)json.getValue("param"), createHandler(msg));
          break;
        }
