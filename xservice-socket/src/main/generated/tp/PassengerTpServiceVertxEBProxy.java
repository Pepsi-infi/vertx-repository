...
public class PassengerTpServiceVertxEBProxy implements PassengerTpService {
  ...
  public PassengerTpServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public PassengerTpServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
