...
public class TpServiceVertxProxyHandler extends ProxyHandler {
  ...
  public TpServiceVertxProxyHandler(Vertx vertx, TpService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public TpServiceVertxProxyHandler(Vertx vertx, TpService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public TpServiceVertxProxyHandler(Vertx vertx, TpService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
