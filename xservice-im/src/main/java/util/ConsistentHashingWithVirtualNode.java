...
public class ConsistentHashingWithVirtualNode<T> {
	...
	public ConsistentHashingWithVirtualNode(List<T> realNodes) {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final ConsistentHashingWithVirtualNode<Node> sh = new ConsistentHashingWithVirtualNode<Node>(ndList);
