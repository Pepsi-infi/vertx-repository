...
public class MsgStatDaoVertxEBProxy implements MsgStatDao {
  ...
  public MsgStatDaoVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MsgStatDaoVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void statPushMsg(int action, String msgId, int osType, Handler<AsyncResult<String>> result) {
    ...
    _json.put("msgId", msgId);
    _json.put("osType", osType);
