  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "statPushMsg": {
          service.statPushMsg(json.getValue("action") == null ? null : (json.getLong("action").intValue()), (java.lang.String)json.getValue("msgId"), json.getValue("osType") == null ? null : (json.getLong("osType").intValue()), res -> {
            if (res.failed()) {
