...
public class TransferDeviceServiceVertxEBProxy implements TransferDeviceService {
  ...
  public TransferDeviceServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public TransferDeviceServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void transferDevice(Handler<AsyncResult<BaseResponse>> result) {
    ...
    _deliveryOptions.addHeader("action", "transferDevice");
