...
public class MsgStatResultServiceVertxEBProxy implements MsgStatResultService {
  ...
  public MsgStatResultServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MsgStatResultServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
