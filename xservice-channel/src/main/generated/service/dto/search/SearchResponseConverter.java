...
/**
 * Converter for {@link service.dto.search.SearchResponse}.
 *
 * NOTE: This class has been automatically generated from the {@link service.dto.search.SearchResponse} original class using Vert.x codegen.
 */
public class SearchResponseConverter {
  ...
  public static void fromJson(JsonObject json, SearchResponse obj) {
    if (json.getValue("data") instanceof JsonObject) {
      obj.setData(new service.dto.search.FilterResultDto((JsonObject)json.getValue("data")));
    }
