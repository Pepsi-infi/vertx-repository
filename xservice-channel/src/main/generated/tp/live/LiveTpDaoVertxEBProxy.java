...
public class LiveTpDaoVertxEBProxy implements LiveTpDao {
  ...
  public LiveTpDaoVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public LiveTpDaoVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void getLunBoDataFromCloudPlatform(String searchUrl, Handler<AsyncResult<String>> result) {
    ...
    _json.put("searchUrl", searchUrl);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getLunBoDataFromCloudPlatform");
  ...
  public void getZhiBoDataFromCloudPlatform(String searchUrl, Handler<AsyncResult<String>> result) {
    ...
    _json.put("searchUrl", searchUrl);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getZhiBoDataFromCloudPlatform");
    _vertx.eventBus().<String>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getZhiBoDataFromLMSBySearchUrl(String url, String sourceId, int offSet, int fetchSize, String splatid, Handler<AsyncResult<String>> result) {
    ...
    _json.put("fetchSize", fetchSize);
    _json.put("splatid", splatid);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getZhiBoDataFromLMSBySearchUrl");
    _vertx.eventBus().<String>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getProgramWaterMark(ProgramWaterMarkRequest request, Handler<AsyncResult<String>> result) {
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getProgramWaterMark");
    _vertx.eventBus().<String>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getTheaterWaterMark(TheaterWaterMarkRequest request, Handler<AsyncResult<String>> result) {
    ...
    _json.put("request", request == null ? null : request.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getTheaterWaterMark");
    _vertx.eventBus().<String>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getTpPlayBillCurrent(PlayBillCurrentRequest request, Handler<AsyncResult<PlayBillCurrentTpResponse>> result) {
    ...
    _json.put("request", request == null ? null : request.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getTpPlayBillCurrent");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
        result.handle(Future.succeededFuture(res.result().body() == null ? null : new PlayBillCurrentTpResponse(res.result().body())));
                      }
    });
  }
