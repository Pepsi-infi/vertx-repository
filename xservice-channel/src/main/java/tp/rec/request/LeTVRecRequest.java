...
public class LeTVRecRequest extends RecBaseRequest {
    public static String REQ_HOST="us.rec.letv.com";
    private static final String REQ_URL = "/tv_le/";
    private String mpt = "";
    private String version = "";

    private String pt = "0004";
    ...
    public LeTVRecRequest() {
    }


    public LeTVRecRequest(JsonObject json) {
        // A converter is generated to easy the conversion from and to JSON.
        LeTVRecRequestConverter.fromJson(json, this);
    }

    public JsonObject toJson() {
        JsonObject json = new JsonObject();
        LeTVRecRequestConverter.toJson(this, json);
        return json;
    }
