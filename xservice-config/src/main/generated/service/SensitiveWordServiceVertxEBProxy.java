...
public class SensitiveWordServiceVertxEBProxy implements SensitiveWordService {
  ...
  public SensitiveWordServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public SensitiveWordServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void addSensitiveWord(JsonObject jsonObject, Handler<AsyncResult<JsonObject>> result) {
    ...
    _deliveryOptions.addHeader("action", "addSensitiveWord");
  ...
  public void getSensitiveWord(int id, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getSensitiveWord");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void updateSensitiveWord(JsonObject jsonObject, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("jsonObject", jsonObject);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "updateSensitiveWord");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void deleteSensitiveWord(int id, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteSensitiveWord");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void querySensitiveWord(JsonObject jsonObject, int page, int limit, Handler<AsyncResult<String>> result) {
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "querySensitiveWord");
