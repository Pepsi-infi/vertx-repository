...
public class ImCommonLanguageServiceVertxEBProxy implements ImCommonLanguageService {
  ...
  public ImCommonLanguageServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ImCommonLanguageServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void addImCommonLanguage(JsonObject jsonObject, Handler<AsyncResult<JsonObject>> result) {
    ...
    _deliveryOptions.addHeader("action", "addImCommonLanguage");
  ...
  public void getImCommonLanguage(int id, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getImCommonLanguage");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void updateImCommonLanguage(JsonObject jsonObject, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("jsonObject", jsonObject);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "updateImCommonLanguage");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void deleteImCommonLanguage(int id, Handler<AsyncResult<JsonObject>> result) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteImCommonLanguage");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
