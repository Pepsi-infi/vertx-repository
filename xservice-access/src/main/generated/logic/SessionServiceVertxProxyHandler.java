...
public class SessionServiceVertxProxyHandler extends ProxyHandler {
  ...
  public SessionServiceVertxProxyHandler(Vertx vertx, SessionService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public SessionServiceVertxProxyHandler(Vertx vertx, SessionService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public SessionServiceVertxProxyHandler(Vertx vertx, SessionService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
    ...
    try {
      ...
      switch (action) {
        ...
        case "getUidByHandlerId": {
          service.getUidByHandlerId((java.lang.String)json.getValue("handlerId"), createHandler(msg));
          break;
        }
        default: {
