...
//        });
        ...
        client.postAbs("http://10.0.200.54/webservice/passenger/webservice/chat/checkSocket").putHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8")
                .addQueryParam("uid", "16320083")
