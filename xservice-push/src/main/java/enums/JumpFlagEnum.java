...
public enum JumpFlagEnum {
	...
	MEMBER_JOURNEY_PAGE(3,"sqyc://01zhuanche.com/mytrip","用户行程页"),
	MEMBER_ACCOUNT_PAGE(4,"sqyc://01zhuanche.com/account","个人账户页"),
	...
	INVITE_FRIENDS_PAGE(8,"sqyc://01zhuanche.com/messageCenter","邀请好友页");
