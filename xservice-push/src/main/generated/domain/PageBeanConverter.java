...
/**
 * Converter for {@link domain.PageBean}.
 *
 * NOTE: This class has been automatically generated from the {@link domain.PageBean} original class using Vert.x codegen.
 */
public class PageBeanConverter {

  public static void fromJson(JsonObject json, PageBean obj) {
    ...
    if (json.getValue("list") instanceof JsonArray) {
      java.util.ArrayList<domain.PassengerMsgDto> list = new java.util.ArrayList<>();
      json.getJsonArray("list").forEach( item -> {
        if (item instanceof JsonObject)
          list.add(new domain.PassengerMsgDto((JsonObject)item));
      });
      obj.setList(list);
    }
  ...
  public static void toJson(PageBean obj, JsonObject json) {
