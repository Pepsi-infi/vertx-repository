...
public class DriverServiceVertxProxyHandler extends ProxyHandler {
  ...
  public DriverServiceVertxProxyHandler(Vertx vertx, DriverService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public DriverServiceVertxProxyHandler(Vertx vertx, DriverService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public DriverServiceVertxProxyHandler(Vertx vertx, DriverService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "saveDriver": {
          service.saveDriver((io.vertx.core.json.JsonObject)json.getValue("jsonObject"), createHandler(msg));
          break;
        }
        case "queryDriver": {
