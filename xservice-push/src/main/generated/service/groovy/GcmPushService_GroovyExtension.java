...
public class GcmPushService_GroovyExtension {
  public static void sendMsg(service.GcmPushService j_receiver, java.util.Map<String, Object> recieveMsg, io.vertx.core.Handler<io.vertx.core.AsyncResult<java.util.Map<String, Object>>> resultHandler) {
