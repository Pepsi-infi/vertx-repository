...
public class NonAdMessagePushServiceVertxEBProxy implements NonAdMessagePushService {
  ...
  public NonAdMessagePushServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public NonAdMessagePushServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
