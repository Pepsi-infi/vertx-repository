...
@io.vertx.lang.rxjava.RxGen(channel.ApplePushService.class)
public class ApplePushService {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<ApplePushService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new ApplePushService((channel.ApplePushService) obj),
    ApplePushService::getDelegate
  );

  private final channel.ApplePushService delegate;
  
  public ApplePushService(channel.ApplePushService delegate) {
    this.delegate = delegate;
  }

  public channel.ApplePushService getDelegate() {
    return delegate;
  }

  public static ApplePushService createProxy(Vertx vertx) { 
    ApplePushService ret = ApplePushService.newInstance(channel.ApplePushService.createProxy(vertx.getDelegate()));
    return ret;
  }

  public static ApplePushService createLocalProxy(Vertx vertx) { 
    ApplePushService ret = ApplePushService.newInstance(channel.ApplePushService.createLocalProxy(vertx.getDelegate()));
    return ret;
  }

  public static String getLocalAddress(String ip) { 
    String ret = channel.ApplePushService.getLocalAddress(ip);
    return ret;
  }
  ...
  public static  ApplePushService newInstance(channel.ApplePushService arg) {
