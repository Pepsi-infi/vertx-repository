...
public class ImMessagePushServiceVertxEBProxy implements ImMessagePushService {
  ...
  public ImMessagePushServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ImMessagePushServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
