  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "saveData": {
          service.saveData((io.vertx.core.json.JsonObject)json.getValue("json"), createHandler(msg));
          break;
        }
        case "updateData": {
        ...
        case "findOffLineMessage": {
          service.findOffLineMessage((io.vertx.core.json.JsonObject)json.getValue("query"), createHandler(msg));
          break;
        }
        default: {
