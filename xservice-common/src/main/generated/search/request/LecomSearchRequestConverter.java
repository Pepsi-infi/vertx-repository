...
/**
 * Converter for {@link search.request.LecomSearchRequest}.
 *
 * NOTE: This class has been automatically generated from the {@link search.request.LecomSearchRequest} original class using Vert.x codegen.
 */
public class LecomSearchRequestConverter {

  public static void fromJson(JsonObject json, LecomSearchRequest obj) {
  ...
  public static void toJson(LecomSearchRequest obj, JsonObject json) {
    if (obj.getArea() != null) {
