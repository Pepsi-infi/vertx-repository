...
public class WhiteListServiceVertxEBProxy implements WhiteListService {
  ...
  public WhiteListServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public WhiteListServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void addDevId(String uuid, WhiteListRequest request, Handler<AsyncResult<WhiteListResponse>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "addDevId");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new WhiteListResponse(res.result().body())));
                      }
    });
  }
  ...
  public void removeDevId(String uuid, WhiteListRequest request, Handler<AsyncResult<WhiteListResponse>> resultHandler) {
    ...
    _json.put("request", request == null ? null : request.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "removeDevId");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void retrieveDevId(String uuid, WhiteListRequest request, Handler<AsyncResult<WhiteListResponse>> resultHandler) {
    ...
    _json.put("request", request == null ? null : request.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveDevId");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
