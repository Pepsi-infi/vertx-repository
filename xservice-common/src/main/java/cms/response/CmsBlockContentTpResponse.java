...
public class CmsBlockContentTpResponse{
...
//    private SubjectDataTpResponse kztInfo;
    ...
    public CmsBlockContentTpResponse() {
    }


    public CmsBlockContentTpResponse(JsonObject json) {
        // A converter is generated to easy the conversion from and to JSON.
        CmsBlockContentTpResponseConverter.fromJson(json, this);
    }

    public JsonObject toJson() {
        JsonObject json = new JsonObject();
        CmsBlockContentTpResponseConverter.toJson(this, json);
        return json;
    }
