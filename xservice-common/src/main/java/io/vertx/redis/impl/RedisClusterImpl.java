...
import static io.vertx.redis.impl.RedisCommand.APPEND;
import static io.vertx.redis.impl.RedisCommand.BLPOP;
import static io.vertx.redis.impl.RedisCommand.BRPOP;
import static io.vertx.redis.impl.RedisCommand.BRPOPLPUSH;
import static io.vertx.redis.impl.RedisCommand.DECR;
import static io.vertx.redis.impl.RedisCommand.DECRBY;
import static io.vertx.redis.impl.RedisCommand.DEL;
import static io.vertx.redis.impl.RedisCommand.EXISTS;
import static io.vertx.redis.impl.RedisCommand.EXPIRE;
import static io.vertx.redis.impl.RedisCommand.EXPIREAT;
import static io.vertx.redis.impl.RedisCommand.GET;
import static io.vertx.redis.impl.RedisCommand.GETBIT;
import static io.vertx.redis.impl.RedisCommand.GETRANGE;
import static io.vertx.redis.impl.RedisCommand.GETSET;
import static io.vertx.redis.impl.RedisCommand.HDEL;
import static io.vertx.redis.impl.RedisCommand.HEXISTS;
import static io.vertx.redis.impl.RedisCommand.HGET;
import static io.vertx.redis.impl.RedisCommand.HGETALL;
import static io.vertx.redis.impl.RedisCommand.HINCRBY;
import static io.vertx.redis.impl.RedisCommand.HINCRBYFLOAT;
import static io.vertx.redis.impl.RedisCommand.HKEYS;
import static io.vertx.redis.impl.RedisCommand.HLEN;
import static io.vertx.redis.impl.RedisCommand.HMGET;
import static io.vertx.redis.impl.RedisCommand.HMSET;
import static io.vertx.redis.impl.RedisCommand.HSET;
import static io.vertx.redis.impl.RedisCommand.HSETNX;
import static io.vertx.redis.impl.RedisCommand.HVALS;
import static io.vertx.redis.impl.RedisCommand.INCR;
import static io.vertx.redis.impl.RedisCommand.INCRBY;
import static io.vertx.redis.impl.RedisCommand.INCRBYFLOAT;
import static io.vertx.redis.impl.RedisCommand.LINDEX;
import static io.vertx.redis.impl.RedisCommand.LINSERT;
import static io.vertx.redis.impl.RedisCommand.LLEN;
import static io.vertx.redis.impl.RedisCommand.LPOP;
import static io.vertx.redis.impl.RedisCommand.LPUSH;
import static io.vertx.redis.impl.RedisCommand.LPUSHX;
import static io.vertx.redis.impl.RedisCommand.LRANGE;
import static io.vertx.redis.impl.RedisCommand.LREM;
import static io.vertx.redis.impl.RedisCommand.LSET;
import static io.vertx.redis.impl.RedisCommand.LTRIM;
import static io.vertx.redis.impl.RedisCommand.MGET;
import static io.vertx.redis.impl.RedisCommand.RPOP;
import static io.vertx.redis.impl.RedisCommand.RPOPLPUSH;
import static io.vertx.redis.impl.RedisCommand.RPUSH;
import static io.vertx.redis.impl.RedisCommand.RPUSHX;
import static io.vertx.redis.impl.RedisCommand.SADD;
import static io.vertx.redis.impl.RedisCommand.SCARD;
import static io.vertx.redis.impl.RedisCommand.SET;
import static io.vertx.redis.impl.RedisCommand.SETEX;
import static io.vertx.redis.impl.RedisCommand.SETNX;
import static io.vertx.redis.impl.RedisCommand.SETRANGE;
import static io.vertx.redis.impl.RedisCommand.SISMEMBER;
import static io.vertx.redis.impl.RedisCommand.SMEMBERS;
import static io.vertx.redis.impl.RedisCommand.SPOP;
import static io.vertx.redis.impl.RedisCommand.SREM;
import static io.vertx.redis.impl.RedisCommand.STRLEN;
import static io.vertx.redis.impl.RedisCommand.TTL;
import static io.vertx.redis.impl.RedisCommand.TYPE;
import static io.vertx.redis.impl.RedisCommand.ZADD;
import static io.vertx.redis.impl.RedisCommand.ZCARD;
import static io.vertx.redis.impl.RedisCommand.ZCOUNT;
import static io.vertx.redis.impl.RedisCommand.ZINCRBY;
import static io.vertx.redis.impl.RedisCommand.ZLEXCOUNT;
import static io.vertx.redis.impl.RedisCommand.ZRANGE;
import static io.vertx.redis.impl.RedisCommand.ZRANGEBYLEX;
import static io.vertx.redis.impl.RedisCommand.ZRANGEBYSCORE;
import static io.vertx.redis.impl.RedisCommand.ZRANK;
import static io.vertx.redis.impl.RedisCommand.ZREM;
import static io.vertx.redis.impl.RedisCommand.ZREMRANGEBYLEX;
import static io.vertx.redis.impl.RedisCommand.ZREMRANGEBYRANK;
import static io.vertx.redis.impl.RedisCommand.ZREMRANGEBYSCORE;
import static io.vertx.redis.impl.RedisCommand.ZREVRANGE;
import static io.vertx.redis.impl.RedisCommand.ZREVRANGEBYLEX;
import static io.vertx.redis.impl.RedisCommand.ZREVRANGEBYSCORE;
import static io.vertx.redis.impl.RedisCommand.ZREVRANK;
import static io.vertx.redis.impl.RedisCommand.ZSCORE;
...
public class RedisClusterImpl extends AbstractRedisClusterClient {
    ...
    @Override
    public RedisCluster delMany(List<String> keys, Handler<AsyncResult<Long>> handler) {
    ...
    @Override
    public RedisCluster mgetMany(List<String> keys, Handler<AsyncResult<JsonArray>> handler) {
        if(!CollectionUtils.isEmpty(keys)){
            JsonArray jsonArray = new JsonArray();
            List<Future<JsonArray>> futures = Lists.newArrayList();
            for(String key : keys){
                Future<JsonArray> future = Future.future();
                sendJsonArray(MGET, toPayload(key), RedisClusterCRC16.getSlot(key), future.completer());
                futures.add(future);
            }
            Future<List<JsonArray>> result = Functional.sequenceFuture(futures);
            result.setHandler(r -> {
                if(r.succeeded()){
                    List<JsonArray> res = r.result();
