...
import redis.impl.RedisClusterImpl;
...
public interface RedisCluster {
	...
	RedisCluster delMany(List<String> keys, Handler<AsyncResult<Long>> handler);
	...
	RedisCluster linsert(String key, InsertOptions option, String pivot, String value,
	...
	RedisCluster mgetMany(List<String> keys, Handler<AsyncResult<JsonArray>> handler);
	...
	RedisCluster zrangeWithOptions(String key, long start, long stop, RangeOptions options,
			Handler<AsyncResult<JsonArray>> handler);

	RedisCluster zrangebylex(String key, String min, String max, LimitOptions options,
			Handler<AsyncResult<JsonArray>> handler);

	RedisCluster zrangebyscore(String key, String min, String max, RangeLimitOptions options,
			Handler<AsyncResult<JsonArray>> handler);
	...
	RedisCluster zrevrange(String key, long start, long stop, RangeOptions options,
			Handler<AsyncResult<JsonArray>> handler);

	RedisCluster zrevrangebylex(String key, String max, String min, LimitOptions options,
			Handler<AsyncResult<JsonArray>> handler);

	RedisCluster zrevrangebyscore(String key, String max, String min, RangeLimitOptions options,
			Handler<AsyncResult<JsonArray>> handler);
